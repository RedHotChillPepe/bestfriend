        ...
        <DrawerContentScrollView style={{marginTop:'15%'}} {...props}>
            <View style={{backgroundColor:'#3C62DD', height:"100%", borderBottomRightRadius:25, flexDirection:'column', justifyContent:'space-between'}}>
                ...
                <View style={{alignItems:'center', paddingBottom:'10%', paddingTop:'10%'}}>
                    <Button onPress={() => navigation.dispatch(DrawerActions.toggleDrawer())} style={{borderRadius:8, width:115}} textColor='#3C62DD' buttonColor='#FFF' mode='contained'>Закрыть</Button>
                </View>
            </View>        
